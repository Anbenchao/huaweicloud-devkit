...
3. Use toolkit MCP tools only for redacted profile or read-only inspection.
4. Do not print AK/SK, tokens, passwords, credential files, or raw profile secrets.
5. Summarize missing prerequisites and the next command I should run manually.
